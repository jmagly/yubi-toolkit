...
printf '{"serial":12345678,"management_algorithm":"AES256","management_key":"%064d","pin":"12345678","puk":"Ab12Cd34","slot1":{"kind":"static","password":"%s"},"slot2":{"kind":"yubiotp","aes_key":"%032d","private_id":"%012d"},"fido_pin":"12345678"}\n' \
